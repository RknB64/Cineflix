...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : Dim 11 fév. 2024 à 13:36
...
INSERT INTO `adherent` (`id`, `nom`, `prenom`, `mail`, `password`, `points`, `date_de_creation`, `compte`, `id_ville`) VALUES
...
CREATE TABLE IF NOT EXISTS `film` (
  ...
  `etat` enum('cinéma','streaming') NOT NULL,
  `id_affiche` int(20) NOT NULL,
  `date_de_sortie` timestamp NOT NULL,
  `date_de_expiration` timestamp NOT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
INSERT INTO `film` (`Id`, `titre`, `description`, `duree`, `etat`, `id_affiche`, `date_de_sortie`, `date_de_expiration`) VALUES
...
CREATE TABLE IF NOT EXISTS `stream` (
  ...
  `date_de_expiration` timestamp(6) NOT NULL,
  `id_film` int(20) NOT NULL,
  `id_adherent` int(20) NOT NULL,
...
INSERT INTO `stream` (`date_achat`, `date_de_expiration`, `id_film`, `id_adherent`) VALUES
